    ...
    <div class="navigasibar">
      <div class="profile">
        <svg height="200" width="200">
          <circle cx="100" cy="100" r="80" stroke="black" stroke-width="2" fill="white" />
        </svg>
      ...
      <div class="listbar">
        ...
        <button class="btn btn-toggle align-items-center rounded text-white">Lihat Semua Jadwal</button>
